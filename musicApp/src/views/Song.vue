<template>
  ...
  <section class="container mx-auto mt-6">
    <div class="bg-white rounded border border-gray-200 relative flex flex-col">
      ...
      <div class="p-6">
        <div
          class="text-white text-center mb-4 font-bold p-4"
          v-if="comment_show_alert"
          :class="comment_alert_variant"
        >
          {{ comment_alert_message }}
        </div>
        <vee-form :validation-schema="schema" @submit="addComent" v-if="userLoggedIn">
          <vee-field
            as="textarea"
            name="comment"
...
export default {
  ...
  methods: {
    ...
    async addComent(values, { resetForm }) {
      ...
      this.comment_alert_message = 'Your comment was added successfully!'
